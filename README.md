...
A Home Assistant custom integration that exposes Swedish DSO (Distribution System Operator) grid tariffs as sensors — and optionally tracks your **running grid cost** for the billing period. It complements spot-price integrations such as Nordpool or Tibber by covering the network charge side of your electricity bill — the part you pay your grid owner, not your electricity supplier.
